...
import { EDUCATION_DATA, SECTION_CONFIG } from '../constants';
...
const Education: React.FC = () => {
  return (
    <section id="education" className="py-20">
      <SectionTitle title={SECTION_CONFIG.education.title} />
      <div className="relative border-l-2 border-gray-700 ml-6">
        {EDUCATION_DATA.map((item: ExperienceItem, index: number) => {
          return (
